def call(){
    ...
    def response = "curl -v -k -X POST -H \"Content-Type: application/json\" -d '${json}' http://admin:admin123@http://18.224.155.110:8081/nexus/service/local/repositories".execute().text
